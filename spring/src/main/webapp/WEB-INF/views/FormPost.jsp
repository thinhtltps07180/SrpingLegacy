...
<body>
	...
	<div class="row" style="margin-top: 20px">
		<div class=" col-md-6 col-sm-offset-2 col-md-offset-3">
			<form:form modelAttribute="postAtb" action="createPost" method="post"
		...
		var openFile = function(field) {
			...
			reader.onload = function() {
				...
				img.onload = function() {
					...
					document.getElementsByTagName("img")[0].setAttribute("id", "after"); 
					console.log(document.getElementById("after").src);
				}
