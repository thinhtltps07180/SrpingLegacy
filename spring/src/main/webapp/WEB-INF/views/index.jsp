	...
	<div id="slides" class="cover-slides">
		<ul class="slides-container">
			<li class="text-left"><img
				src="resources/ClientTemplate/images/slider-01.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20">
			...
			<li class="text-left"><img
				src="resources/ClientTemplate/images/slider-02.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20">
			...
			<li class="text-left"><img
				src="resources/ClientTemplate/images/slider-03.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
					<img src="resources/ClientTemplate/images/about-img.jpg" alt=""
						class="img-fluid">
				</div>
			</div>
		</div>
							...
							<div class="row">
								<div class="col-lg-4 col-md-6 special-grid drinks">
									<div class="gallery-single fix">
										<img src="resources/ClientTemplate/images/img-01.jpg"
								...
								<div class="col-lg-4 col-md-6 special-grid drinks">
									<div class="gallery-single fix">
										<img src="resources/ClientTemplate/images/img-02.jpg"
											class="img-fluid" alt="Image">
										<div class="why-text">
								...
								<div class="col-lg-4 col-md-6 special-grid drinks">
									<div class="gallery-single fix">
										<img src="resources/ClientTemplate/images/img-03.jpg"
											class="img-fluid" alt="Image">
										<div class="why-text">
								...
								<div class="col-lg-4 col-md-6 special-grid lunch">
									<div class="gallery-single fix">
										<img src="resources/ClientTemplate/images/img-04.jpg"
											class="img-fluid" alt="Image">
										<div class="why-text">
								...
								<div class="col-lg-4 col-md-6 special-grid lunch">
									<div class="gallery-single fix">
										<img src="resources/ClientTemplate/images/img-05.jpg"
											class="img-fluid" alt="Image">
										<div class="why-text">
								...
								<div class="col-lg-4 col-md-6 special-grid lunch">
									<div class="gallery-single fix">
										<img src="resources/ClientTemplate/images/img-06.jpg"
											class="img-fluid" alt="Image">
										<div class="why-text">
								...
								<div class="col-lg-4 col-md-6 special-grid dinner">
									<div class="gallery-single fix">
										<img src="resources/ClientTemplate/images/img-07.jpg"
											class="img-fluid" alt="Image">
										<div class="why-text">
								...
								<div class="col-lg-4 col-md-6 special-grid dinner">
									<div class="gallery-single fix">
										<img src="resources/ClientTemplate/images/img-08.jpg"
											class="img-fluid" alt="Image">
										<div class="why-text">
								...
								<div class="col-lg-4 col-md-6 special-grid dinner">
									<div class="gallery-single fix">
										<img src="resources/ClientTemplate/images/img-09.jpg"
											class="img-fluid" alt="Image">
										<div class="why-text">
			...
			<div class="tz-gallery">
				<div class="row">
					<div class="col-sm-12 col-md-4 col-lg-4">
						<a class="lightbox"
							href="resources/ClientTemplate/images/gallery-img-01.jpg"> <img
							class="img-fluid"
							src="resources/ClientTemplate/images/gallery-img-01.jpg"
							alt="Gallery Images">
						</a>
					</div>
					<div class="col-sm-6 col-md-4 col-lg-4">
						<a class="lightbox"
							href="resources/ClientTemplate/images/gallery-img-02.jpg"> <img
							class="img-fluid"
							src="resources/ClientTemplate/images/gallery-img-02.jpg"
							alt="Gallery Images">
						</a>
					</div>
					<div class="col-sm-6 col-md-4 col-lg-4">
						<a class="lightbox"
							href="resources/ClientTemplate/images/gallery-img-03.jpg"> <img
							class="img-fluid"
							src="resources/ClientTemplate/images/gallery-img-03.jpg"
							alt="Gallery Images">
						</a>
					</div>
					<div class="col-sm-12 col-md-4 col-lg-4">
						<a class="lightbox"
							href="resources/ClientTemplate/images/gallery-img-04.jpg"> <img
							class="img-fluid"
							src="resources/ClientTemplate/images/gallery-img-04.jpg"
							alt="Gallery Images">
						</a>
					</div>
					<div class="col-sm-6 col-md-4 col-lg-4">
						<a class="lightbox"
							href="resources/ClientTemplate/images/gallery-img-05.jpg"> <img
							class="img-fluid"
							src="resources/ClientTemplate/images/gallery-img-05.jpg"
							alt="Gallery Images">
						</a>
					</div>
					<div class="col-sm-6 col-md-4 col-lg-4">
						<a class="lightbox"
							href="resources/ClientTemplate/images/gallery-img-06.jpg"> <img
							class="img-fluid"
							src="resources/ClientTemplate/images/gallery-img-06.jpg"
							alt="Gallery Images">
						</a>
					</div>
				</div>
							...
							<div class="carousel-item text-center active">
								<div class="img-box p-1 border rounded-circle m-auto">
									<img class="d-block w-100 rounded-circle"
										src="resources/ClientTemplate/images/quotations-button.png"
										alt="">
								</div>
								<h5 class="mt-4 mb-0">
